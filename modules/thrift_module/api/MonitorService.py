...
class Processor(Iface, TProcessor):
    ...
    def process_Recv(self, seqid, iprot, oprot):
        ...
        result = Recv_result()
        try:
            result.success = self._handler.Recv(args.req)
...
Recv_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [MonitorRequest, None], None, ),  # 1
)
...
Recv_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [MonitorResponse, None], None, ),  # 0
)
